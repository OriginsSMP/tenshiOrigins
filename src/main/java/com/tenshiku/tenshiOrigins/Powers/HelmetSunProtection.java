package com.tenshiku.tenshiOrigins.Powers;
...
public class HelmetSunProtection implements VisibleAbility, Listener {

    @Override
    public @NotNull Key getKey() {
        return Key.key("tenshiorigins", "helmet_sun_protection");
    }

    @Override
    public String title() {
        return "Helmet Sun Protection";
    }
